    ...
    stages {
        ...
        stage('Deploy the App') {
            steps {
                ...
                ansiblePlaybook become: true, colorized: true, credentialsId: 'seryum', disableHostKeyChecking: true, installation: 'ansible', inventory: '/home/ec2-user/inventory.txt', playbook: 'todo_project.yml'
             }
        }
